"""Deploy pdp_sessions_Vfinal as a daily BigQuery scheduled query.

Runs 30 minutes after the KPI Funnel V2 schedule so session_facts
has been rebuilt first (pdp_sessions_Vfinal reads from it).
Idempotent: safe to run repeatedly.

Usage:
    python deploy_pdp.py
"""
...
DISPLAY_NAME = "PDP Sessions V-Final - Page-level Funnel"

SQL_FILES = ["pdp_sessions_Vfinal.sql"]
