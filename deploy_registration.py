"""Deploy channel_registration_form_Vfinal as a daily BigQuery scheduled query.

Runs 30 minutes after the KPI Funnel V2 schedule so session_facts
has been rebuilt first (channel_registration_form_Vfinal reads from it).
Idempotent: safe to run repeatedly.

Usage:
    python deploy_registration.py
"""
...
DISPLAY_NAME = "Channel Registration Form V-Final - Registration Funnel"

SQL_FILES = ["channel_registration_form_Vfinal.sql"]
